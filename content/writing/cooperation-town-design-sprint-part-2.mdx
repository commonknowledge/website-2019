---
title: "Cooperation Town design sprint (Part 2)"
date: 2021-03-22
...
To prepare for this sprint, we started with [Miro's remote design sprint template](https://miro.com/templates/remote-design-sprint/), took note of the recommendations made in some articles by people who've done it before (like [this](https://medium.com/nomoko/how-to-do-a-design-sprint-remotely-amidst-coronavirus-pandemic-870bb57febd5), [this](https://www.thesprintbook.com/remote), [this](https://prototypr.io/post/remote-working-in-design-part-2-of-a-design-sprint-trilogy/), [this](https://spotify.design/article/how-to-lead-a-remote-design-sprint) and [this](https://sprintstories.com/the-design-sprint-note-n-map-a9bf0ca88f51)) and then worked some of the original scheduling made in the *Sprint!* book back into the agenda. If you don't have the book, that's fine! They've put almost [everything, including the agenda](https://www.thesprintbook.com/how), online for free.
...
We probably spent half as long on workshopping, compared to a normal design sprint. This was mainly due to how exhausting video calls are, compared to real-life interactions. Spending longer might have refined things, but the goal of a sprint isn't to produce perfect outcomes so much as to shake a project into creative, reflective action.

![Screenshot of a Miro board with lots of comments, images and sticky notes, with an agenda open on the right side](../../assets/coop-town-miro.png)
...
Because these tools might have been unfamiliar and we'd never met each other before, we arranged a quick technical warm-up session with us and our Co-op Town collaborators. This was useful because it meant we were able to lift each other up to 'power user' level. It gave everyone a bit more fluency and confidence to participate equally in the substantive exercises.
...
This was a really exciting and eye-opening day. We spent the time learning as much as possible about the organising experience. We had a lot of puzzles and ideas around digitally-mediated peer-to-peer learning, so we invited an e-learning professional to join the workshops and give their take.
...
Worse, new starters are often **intimidated** by the amount of effort involved and **unconfident in their abilities.** Speaking to an unfamiliar neighbour and boldly declaring a new project for the neighbourhood can seem scary. 

What the 1-to-1 phone calls did was help people recognise that the progress they'd made and that they were *already* organising. The key goal for the coordinators was to give new starters the confidence to just try stuff out and work it out as they go.
...
The concern they had was that centrally created, flashy materials can't easily incorporate experiences and new ideas from the field — meaning this might not qualify as a reliable tactic for reproducing this network model with other similar projects.
...
- We noted that building a **safe and structured learning community** was something important to consider throughout. A major risk was that any solution might have the opposite effect of **knocking peoples' confidence**, which is something we get a bit of a feel for in the user testing on Day 5.

### Defining the scope

![An experience map made of sticky notes, outlining the process of setting up and running a food co-op from the perspectives of the network coordinators, organisers and their neighbours](../../assets/coop-town-map.png)
...
In our next post, we'll share more about how we created the prototype and tested it with organisers. Subscribe to our newsletter or follow us on [Twitter](https://twitter.com/cmmonknowledge) for updates.