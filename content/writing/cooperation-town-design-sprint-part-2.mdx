...
In [part one](https://commonknowledge.coop/writing/cooperation-town-design-sprint-part-1-intro/), we introduced Cooperation Town's organising model and how our collaboration came about. In this post we want to open up how and what we learned in the design sprint itself.
...
In our next post, we'll share more about how we created the prototype and tested it with organisers. [Subscribe to our newsletter](https://commonknowledge.us19.list-manage.com/subscribe/post?u=7d61a70102ab811e6282bee60&id=b87cfcec60) or follow us on [Twitter](https://twitter.com/cmmonknowledge) for updates.
