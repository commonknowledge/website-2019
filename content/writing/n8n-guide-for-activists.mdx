...
We’ve seen a lot of ‘digital duct tapping’ whilst working with activists, organisers, campaigners and charity sector workers: smoothing over the cracks between various off-the-shelf tools like Google Sheets, surveys, calendars and whatnot. Automations tooling is basic movement infrastructure!
...
It’s called [n8n.io](http://n8n.io) and it’s an alternative to Zapier that’s robust, flexible, code-available on Github, free to self-host, fairly user-friendly.
...
If you fit into either of the scenarios above, or there’s something else that’s got you burned about Zapier or other subscription tools like it (let us know, we’re curious), then here’s why we think n8n _might_ work for you.
...
Overall, we reckon that the funded team plus open source combination makes n8n a good candidate for progressive activists to assemble around. The integrations and tooling built for one campaign can be easily reused by another organisation also running n8n.
...
You can have it up and running on your local machine in about 10 seconds.
...
You can simply follow this docker-compose guide to get going in a few minutes: [https://docs.n8n.io/reference/server-setup.html#\_5-create-docker-compose-file](https://docs.n8n.io/reference/server-setup.html#_5-create-docker-compose-file)

Quick note that we at Common Knowledge using Digital Ocean / Debian had to edit the `image: n8nio/n8n` bit with`: n8nio/n8n:latest-debian` in order to get SSL-enabled email sending to work properly.
...
- Also consider HTTP logging at the server-level so that application-level failures, however unlikely, don’t lose you data. httpflow ([https://github.com/six-ddc/httpflow](https://github.com/six-ddc/httpflow)) does this well.
...
- At the application level: you can set up error workflows within n8n that catch failures, which is great:
  ...
  See how it works: [https://medium.com/n8n-io/creating-error-workflows-in-n8n-6e03c9ecbc0f](https://medium.com/n8n-io/creating-error-workflows-in-n8n-6e03c9ecbc0f)

  Reference docs on error workflows: [https://docs.n8n.io/reference/workflow.html#data-flow](https://docs.n8n.io/reference/workflow.html#data-flow)
...
This might also be helpful if you want to explore this option: [https://stackoverflow.com/questions/61228036/deploying-n8n-to-heroku](https://stackoverflow.com/questions/61228036/deploying-n8n-to-heroku)
...
- Second, consider installing custom integrations: [https://docs.n8n.io/reference/configuration.html#custom-nodes-location](https://docs.n8n.io/reference/configuration.html#custom-nodes-location)
...
## Are you an activist, organiser, campaigner or work in progressive political/charitable organisations?

[Get in touch](/contact) with us and we’re more than happy to talk this through some more or talk about broader technical and organisational campaigning.
