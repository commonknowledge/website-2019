...
![A diagram from n8n showing Typeform submissions connected to both Action Network and Airtable and then, from Airtable, posting a Slack message.](../../assets/screenshot-n8n-action-network-interface.jpeg)
...
- It’s worth mentioning n8n also has some really good features. It has error handling for workflows and even CLI (command line interface) commands for JSON workflow management and backups, if you’re into that kind of thing! [We've open sourced our n8n workflows in a backup repository here, which you can pick up and use right now.](https://github.com/commonknowledge/n8n-backup)
...
![A screenshot of digitalocean.com showing Common Knowledge Co-op's n8n server is running](../../assets/screenshot-n8n-ck.jpeg)
