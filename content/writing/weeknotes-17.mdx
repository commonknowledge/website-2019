...
We're putting the retrospectives in a database in Notion with the hope that we can identify emerging themes across projects, increase visibility and change the way we work more systematically. We can maybe use this database at other reflection and feedback points like quarterly OKR planning sessions.

We use the [Stop, Start, Continue retrospective format](https://www.groupmap.com/map-templates/start-stop-continue-retrospective/) for all project retrospectives for now to keep them compatible with one another across time and projects, although we're also keen on other matrixes like Appreciations, Problems, Puzzles and Ideas. We can look back at the lists of what we'd like to continue, start or stop when we begin a new project.
...
![Stripe Partners' typology of community-oriented microorganisations](../../assets/stripe-partners-microorganisations.png)
