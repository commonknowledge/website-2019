...
date: 2021-03-11
intro: Tools to help workforces build up a picture of working conditions to transform these conditions and build power
---
...
![Two people working on old IBM 704 computer at NASA in 1957](../../assets/nasa-ibm-type.jpg)
...
If you want to contribute an example, or you’re interested in the project and want to chat, email [hello@commonknowledge.coop](mailto:hello@commonknowledge.coop).

---

_This work in collaboration with Autonomy is supported by the [Barry Amiel & Norman Melburn trust](https://amielandmelburn.org.uk/)._

_Image credit: NASA, Public domain, via Wikimedia Commons_
