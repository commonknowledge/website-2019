...
As we are conducting meetings remotely, we put the order up where someone can see it clearly, so they know who is before and after them. In real life we'd just move round in a circle in the order people are sitting or standing. Typically we decide the order by chance, using random.org.
...
And so on. When a topic warrants it, we will go through a few rounds until it feels natural to stop, or, that we've exhausted the time for discussion or the number of rounds we decided to do before hand. It's easier than you think to gauge when there has been "enough" and it feels the topic is exhausted.
