...
Before every meeting we do, we like to check in. This means going from person to person (talking in [rounds](https://patterns.sociocracy30.org/rounds.html)), saying out loud how we are feeling, if there is anything on our mind and how things are going. We have done this in more or less every meeting we have done since our founding in 2018.
...
As well as at the start of meetings, we do this at the start of every day, as part of our [scrum style meeting](https://www.scrumguides.org/scrum-guide.html#events-daily). We do two rounds:
...
Checking in one of the easiest sociocratic techniques to start doing. If you've read this and decided to try it out, [drop us a line to say how it is going](mailto:hello@commonknowledge.coop).
