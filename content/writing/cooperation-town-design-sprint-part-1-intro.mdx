...
Thanks for reading! In [part two](/writing/cooperation-town-design-sprint-part-2), we talk about how we mapped out the organising process and identified which part of this challenge to address. For more on design sprints, you can also check out:
