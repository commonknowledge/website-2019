...
In our next post, we'll explain how we mapped out the organising process and identified which part of this challenge to address. If you'd like to hear when we publish this, subscribe to our newsletter or follow us on [Twitter](https://twitter.com/cmmonknowledge).
