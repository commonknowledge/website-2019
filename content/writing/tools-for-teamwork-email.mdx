---
title: "Being thoughtful about tools for teamwork: part 1, email"
date: 2021-04-16
intro: "Running a Manual of Me, discovering how your team wants to work, solving email"
---
...
![8 boxes for people to add notes to, with the labels: 1. The things I'm dealing with in my home working environment. 2. The times / hours I like to work. 3. The best ways to communicate with me. 4. The ways I like to receive feedback. 5. Things I need to work well. 6. Things I can struggle with. 7. Things I love. 8. Other things to know about me.](../../assets/Being%20thoughtful%20about%20tools%20for%20teamwork%20part%201,%20%2060abbd71e71545ea8059289ecf767f46/Screenshot_2021-04-16_at_12.16.28.png)
...
Each tool/relation config changes the social-technical dynamic in myriad ways, so changing everything all at once would be a massive learning/sense-making burden on everyone.

On the other hand, changing things piecemeal allows your team to reflect on what changed. It affects the rest of how you work. Your priorities will change. It helps if you have a culture of retrospection to surface these changes and address new tensions that emerge.

The first thing we discussed was everything related to emails. We will continue to address the tools we use in future ~~week~~ retros.
...
![A snippet from an email from our inbox saying "Hi Lucy, Just jumping in for Gemma on some of the prototyping work."](../../assets/Being%20thoughtful%20about%20tools%20for%20teamwork%20part%201,%20%2060abbd71e71545ea8059289ecf767f46/Screenshot_2021-04-16_at_12.31.30.png)
...
- We want to be able to snooze/schedule replies and basically manage emails within the client.
...
- At the moment we move stale emails to Archive and add a Notion task, but this moves 'email thinking' to separate space and these tasks often go out of date. At worst, two people will be simultaneously working on a reply without realising, because there's no sense of who else is looking or responsible.
- But we definitely want to keep the visibility of Inbox 0, for the interest of knowing what's happening, so we can dive in if required, but also so we can always refer back to emails to another person that are relevant to our work.
- For that reason we want to be able to link to emails. Right now, we often direct-quote emails into our Notion for convenience, because how else can you refer to them?
- We want to be able to set up email automations, like automated replies on when we'll get back.
- We also care about security, but it's not our main concern for email. Our basic desire is not to be serfs in a data harvesting fiefdom like Google's. For genuinely sensitive discussions, we will always recommend our collaborators to speak with us on [Signal.org](http://signal.org).

![
Edward Snowden, whistleblower and privacy advocate says "I use Signal every day."](../../assets/Being%20thoughtful%20about%20tools%20for%20teamwork%20part%201,%20%2060abbd71e71545ea8059289ecf767f46/Screenshot_2021-04-16_at_12.39.00.png)
...
- One thing we really dislike is newsletter spam. [Hey.com](http://hey.com) has a handy space for this that takes it out of the main inbox. We're also looking at [Feedly.com](http://feedly.com) as an 'omnichannel for information' to keep on top of things.

In thinking about tools for teamwork, we're reminded of the question, ["What will we stop doing?"](https://emrosebaz.medium.com/10-questions-from-your-future-organisation-bcdbdd9caf7) More to follow when we've done a bit of comparison and further research. Have any thoughts on the above? Get in touch.
