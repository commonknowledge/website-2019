...
date: 2020-02-14
intro: Two articles on the Iowa app debacle for The Guardian and Jacobin
---

We wrote two articles commenting on the failure of digital technology during the Iowa caucus last week.

In _[The Guardian](https://www.theguardian.com/commentisfree/2020/feb/09/bernie-sanders-campaign-people-tech-obama-big-data)_, we compare Obama's campaign tactics to Bernie's, making the distinction between mobilising and organising.
...
In the _[Jacobin](https://jacobinmag.com/2020/02/shadow-inc-app-iowa-caucus-acronym)_ article, we argue that all digital technology needs to be understood as part of a complex social system.
