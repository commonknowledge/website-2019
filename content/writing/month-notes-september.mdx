...
![An overview of the different streams of The World Transformed](../../assets/twt.png)
...
Peace Insight focus on sharing and amplifying grassroots perspectives – an approach that really resonates with us. We're going to be working with them over the next month to make sure that their website fits with this strategy.
...
![Intention wallpaper for democracy](../../assets/intention-democracy-d.jpg)
![Intention wallpaper for pragmatism](../../assets/intention-pragmatism.jpg)
