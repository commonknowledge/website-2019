...
![An in person meeting](../../assets/meeting-in-person.jpg)
...
## Understanding why organisers often prefer in person interactions
...
## Look for group dynamics in online spaces like you would in physical spaces
...
## Learn how different online spaces are structured
...
## We are commited to writing guidance to help you
...
## Choosing the right digital tool for chat

![A phone screen showing apps](../../assets/phone.jpg)
...
## Think about what you need to do before choosing a tool
...
## Don't worry if you are using WhatsApp
...
## Alternatives to WhatsApp are good
...
## Moving from WhatsApp and bringing people with you
...
## Chat is sometimes the wrong tool for the job

However, you may not need a chat app at all. 

[Discourse](https://www.discourse.org/), for example, is an open source forum software that allows you to build a knowledge base and have discussions in a more long-term and structured way. 
...
Here is a great blog by [Doist](https://doist.com/blog/asynchronous-communication/) that describes this well. Sometimes this isn't going to work if you need things to be real-time. But considering if you *do* need it to be real time is important.
...
## Use the same things you would do as an organiser offline online

![Using a smart phone](../../assets/using-a-smart-phone.jpg)
...
If you need specific support, you can [get in touch](mailto:hello@commonknowledge.coop) and we will see what we can do.