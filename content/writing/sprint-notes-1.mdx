...
Agile sprints have always been our preferred way of working, but we've only been able to work like this for a few projects. These were bigger projects with tight deadlines, where we were able to carve out at least two weeks of the full team's time to completely focus on one thing. 
...
![A timeline showing our rotating co-op responsibilities](../../assets/responsbility-cycles.png)
