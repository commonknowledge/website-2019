...
In [part one](https://commonknowledge.coop/writing/cooperation-town-design-sprint-part-1-intro/) and [part two](https://commonknowledge.coop/writing/cooperation-town-design-sprint-part-2/) of this series, we introduced the [Cooperation Town](https://cooperation.town/) project and walked through how we defined a problem to frame our collaboration. Through this process, we identified our sprint goal: how might we give all co-op members the confidence to see themselves as an organiser within a non-hierarchical network?

In this final post, we'll review how we created a prototype, what we learned from testing it with food co-op organisers, some of what we've learned, how it can help us to steer our collaboration with Cooperation Town and how it might be applicable to other community self-organisation projects.
