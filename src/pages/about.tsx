...
const valueStyle = { width: ['100%', '50%'], pr: [0, 5] }

const IndexPage = () => (
    <Fragment>
        <SEO title="Vision, mission, values - Common Knowledge" />
        <GridLayout>
            <Styled.h3 sx={{ fontWeight: "bold", mt: [5], mb: [1, 2] }}>
                Vision
            </Styled.h3>
            <Styled.p>A world of abundance, free from oppression.</Styled.p>
            <Styled.p>To get there, we need people who are confident in their capacity to self-organise, empowered by digital technology.</Styled.p>
            <Styled.h3 sx={{ fontWeight: "bold", mt: [4, 5], mb: [1, 2] }}>
                Mission
            </Styled.h3>
            <Styled.p>Working directly with grassroots activists, we design digital tools that make radical change possible.</Styled.p>
            <Styled.h3 sx={{ fontWeight: "bold", mt: [4, 5], mb: [1, 2] }}>
                Values
            </Styled.h3>
